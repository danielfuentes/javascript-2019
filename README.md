# javascript-2019
Ejemplos diversos sobre Javascript, en los mismos se pueden verificar: Captura de elementos, asignación de propiedades, métodos, validaciones de formularios, Fetch, consumo de API
<hr>
